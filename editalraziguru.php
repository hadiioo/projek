...
$query = "SELECT * FROM al_raziguru WHERE no_kp = '$no_kp'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update the database
    $updateQuery = "UPDATE al_raziguru SET 
                        no_kp = '$no_kp', 
                        nama = '$nama', 
                        no_tel = '$no_tel', 
                        kelas = '$kelas' 
    ...
    if (mysqli_query($connect, $updateQuery)) {
        header("Location: al_raziguru.php"); // Redirect to the data listing page
        exit;
    } else {
...
<body>
    <div class="form-container">
        ...
        <form action="editalraziguru.php?no_kp=<?= $row['no_kp'] ?>" method="post">
