...
<body>
    ...
    <center>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <td>{$row['no_tel']}</td>
                                <td>{$row['kelas']}</td>
                                <td class='actions'><a href=\"parg.php?no_kp={$row['no_kp']}\" onclick=\"return confirm('Rekod ini akan dihapuskan')\">Padam</a></td>
        ...
        <div class="button-container">
            ...
            <a href="al_razi.php"><button class="datapelajar">Data Pelajar</button></a>
        </div>
    </center>
</body>
</html>
