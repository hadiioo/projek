...
<body>
    ...
    <center>
        <table>
            ...
            <?php
                include('config.php');
                $query = "SELECT * FROM al_idrisiguru";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <td><a href='editalidrisiguru.php?no_kp={$row['no_kp']}'>Edit</a></td>
                            </tr>
                            ";
                        }
                    } else {
        ...
        <div class="button-container">
            ...
            <a href="tambahdataalidrisiguru.php"><button class="tambah">&#43; Tambah Guru</button></a>
            <a href="mukadepan.php"><button class="logkeluar">Log Keluar</button></a>
            <a href="al_idrisi.php"><button class="datapelajar">Data Pelajar</button></a>
        </div>
    </center>
</body>
</html>
