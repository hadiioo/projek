...
<head>
    ...
    <title>Tambah Rekod Pelajar Al-jazari</title>
    <style>
        body {
...
<body>
    <div class="form-container">
        <h2>Tambah Rekod Pelajar Al-Jazari</h2>
        <form action="tambahdataaljazari.php" method="post">
            <table>
                <tr>
                    <td>IC PELAJAR</td>
                    <td>:</td>
    ...
    if (isset($_POST['hantar'])) {
        ...
        $query = "INSERT INTO al_jazari ( no_kp, nama, no_tel, kelas) 
                  VALUES ('$no_kp', '$nama', '$no_tel', '$kelas')";
        
        if (mysqli_query($connect, $query)) {
            // Redirect to data.php on success
            header('Location: al_jazari.php');
            exit;
        } else {
