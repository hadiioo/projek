...
<head>
    ...
    <title>Tambah Rekod Pelajar</title>
    <style>
        body {
...
<body>
    <div class="form-container">
        ...
        <form action="tambahdatapelajar.php" method="post">
            <table>
                <tr>
                    <td>IC PELAJAR</td>
                    <td>:</td>
    ...
    if (isset($_POST['hantar'])) {
        ...
        $query = "INSERT INTO data_pelajar ( no_kp, nama, no_tel, kelas) 
                  VALUES ('$no_kp', '$nama', '$no_tel', '$kelas')";
        
        if (mysqli_query($connect, $query)) {
            // Redirect to data.php on success
            header('Location: datapelajar.php');
            exit;
        } else {
