...
<head>
    ...
    <title>Tambah Rekod Guru Al-Razi</title>
    <style>
        body {
...
<body>
    <div class="form-container">
        ...
        <form action="tambahdataalraziguru.php" method="post">
            <table>
                <tr>
                    <td>IC GURU</td>
                    <td>:</td>
    ...
    if (isset($_POST['hantar'])) {
        ...
        $query = "INSERT INTO al_raziguru ( no_kp, nama, no_tel, kelas) 
                  VALUES ('$no_kp', '$nama', '$no_tel', '$kelas')";
        
        if (mysqli_query($connect, $query)) {
            // Redirect to data.php on success
            header('Location: al_raziguru.php');
            exit;
        } else {
