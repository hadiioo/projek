...
<head>
    ...
    <title>Tambah Rekod Guru Al-Jazari</title>
    <style>
        body {
...
<body>
    <div class="form-container">
        <h2>Tambah Rekod Guru Al-Jazari</h2>
        <form action="tambahdataaljazariguru.php" method="post">
            <table>
                <tr>
                    <td>IC GURU</td>
                    <td>:</td>
    ...
    if (isset($_POST['hantar'])) {
        ...
        $query = "INSERT INTO al_jazariguru ( no_kp, nama, no_tel, kelas) 
                  VALUES ('$no_kp', '$nama', '$no_tel', '$kelas')";
        
        if (mysqli_query($connect, $query)) {
            // Redirect to data.php on success
            header('Location: al_jazariguru.php');
            exit;
        } else {
