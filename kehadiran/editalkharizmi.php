...
$query = "SELECT * FROM al_khawarizmi WHERE no_kp = '$no_kp'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update the database
    $updateQuery = "UPDATE al_khawarizmi SET 
                        no_kp = '$no_kp', 
                        nama = '$nama', 
                        no_tel = '$no_tel', 
                        kelas = '$kelas' 
    ...
    if (mysqli_query($connect, $updateQuery)) {
        header("Location: al_khawarizmi.php"); // Redirect to the data listing page
        exit;
    } else {
...
<head>
    ...
    <title>Edit Rekod Pelajar</title>
    <style>
        body {
...
<body>
    <div class="form-container">
        ...
        <form action="editalkhawarizmi.php?no_kp=<?= $row['no_kp'] ?>" method="post">
