...
$query = "SELECT * FROM al_jazari WHERE no_kp = '$no_kp'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update the database
    $updateQuery = "UPDATE al_jazari SET 
                        no_kp = '$no_kp', 
                        nama = '$nama', 
                        no_tel = '$no_tel', 
                        kelas = '$kelas' 
    ...
    if (mysqli_query($connect, $updateQuery)) {
        header("Location: al_jazari.php"); // Redirect to the data listing page
        exit;
    } else {
...
<body>
    <div class="form-container">
        ...
        <form action="editaljazari.php?no_kp=<?= $row['no_kp'] ?>" method="post">
