...
<head>
    ...
    <title>Tambah Rekod Pelajar Al-Farabi</title>
    <style>
        body {
...
<body>
    <div class="form-container">
        <h2>Tambah Rekod Pelajar Al-Farabi</h2>
        <form action="tambahdataalfarabi.php" method="post">
            <table>
                <tr>
                    <td>IC PELAJAR</td>
                    <td>:</td>
    ...
    if (isset($_POST['hantar'])) {
        ...
        $query = "INSERT INTO al_farabi ( no_kp, nama, no_tel, kelas) 
                  VALUES ('$no_kp', '$nama', '$no_tel', '$kelas')";
        
        if (mysqli_query($connect, $query)) {
            // Redirect to data.php on success
            header('Location: al_farabi.php');
            exit;
        } else {
