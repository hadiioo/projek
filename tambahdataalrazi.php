...
<head>
    ...
    <title>Tambah Rekod Pelajar Al-Razi</title>
    <style>
        body {
...
<body>
    <div class="form-container">
        <h2>Tambah Rekod Pelajar Al-Razi</h2>
        <form action="tambahdataalrazi.php" method="post">
            <table>
                <tr>
                    <td>IC PELAJAR</td>
                    <td>:</td>
    ...
    if (isset($_POST['hantar'])) {
        ...
        $query = "INSERT INTO al_razi ( no_kp, nama, no_tel, kelas) 
                  VALUES ('$no_kp', '$nama', '$no_tel', '$kelas')";
        
        if (mysqli_query($connect, $query)) {
            // Redirect to data.php on success
            header('Location: al_razi.php');
            exit;
        } else {
