...
$query = "SELECT * FROM al_jazariguru WHERE no_kp = '$no_kp'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update the database
    $updateQuery = "UPDATE al_jazariguru SET 
                        no_kp = '$no_kp', 
                        nama = '$nama', 
                        no_tel = '$no_tel', 
                        kelas = '$kelas' 
    ...
    if (mysqli_query($connect, $updateQuery)) {
        header("Location: al_jazariguru.php"); // Redirect to the data listing page
        exit;
    } else {
