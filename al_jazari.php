...
<body>
    ...
    <center>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr>
                                ...
                                <td><a href='editaljazari.php?no_kp={$row['no_kp']}'>Edit</a></td>
                            </tr>
                            ";
                        }
                    } else {
        ...
        <div class="button-container">
            <a href="al_jazariguru.php"><button class="sebelum">< Page Sebelum</button></a>
            <a href="tambahdataaljazari.php"><button class="tambah">&#43; Tambah Pelajar</button></a>
